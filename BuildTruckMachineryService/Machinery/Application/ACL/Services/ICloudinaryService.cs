...
/// <summary>
/// Cloudinary service interface for Machinery context
...
public interface ICloudinaryService
{
    ...
    /// <param name="documentationId">Machinery ID for unique naming</param>
    /// <returns>Cloudinary URL</returns>
    Task<string> UploadMachineryImageAsync(byte[] imageBytes, string fileName, int documentationId);
    ...
    Task<bool> DeleteMachineryImageAsync(string imageUrl);
